        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    Form Edit Data Dokter: <?= $dokter->nama_dokter ?>
                </h3>
            </div>
                ...
                <form action="<?= site_url('master/dokter/update') ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            class="form-control" 
                            name="nama_dokter"
                            value="<?= set_value('nama_dokter', $dokter->nama_dokter) ?>" 
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            class="form-control"
                            name="no_izin"
                            value="<?= set_value('no_izin', $dokter->no_izin) ?>" 
                            required
                        >
                    </div>
                    ...
                    <a href="<?= site_url('master/dokter') ?>" class="btn btn-default">
                        Batal
                    </a>
