                ...
                <?php echo form_open('master/pasien/simpan'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_pasien" id="nama_pasien" 
                               value="<?php echo set_value('nama_pasien'); ?>" placeholder="Masukkan nama pasien sesuai KTP" required>
                    </div>

                    <div class="form-group">
                        <label for="tgl_lahir"><i class="fa fa-calendar"></i> Tanggal Lahir</label>
                        <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" 
                               value="<?php echo set_value('tgl_lahir'); ?>" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="no_telp"><i class="fa fa-phone"></i> Nomor Telepon/HP</label>
                        <input type="text" class="form-control" name="no_telp" id="no_telp" 
                               value="<?php echo set_value('no_telp'); ?>" placeholder="Contoh: 0812xxxx" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="alamat"><i class="fa fa-home"></i> Alamat Lengkap</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="4" required><?php echo set_value('alamat'); ?></textarea>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan Data Pasien</button>
