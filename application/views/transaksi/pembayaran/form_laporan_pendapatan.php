            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date"
                           ...
                           id="tgl_awal"
                           class="form-control"
                           value="<?php echo html_escape($tgl_awal); ?>"
                           required>
                </div>
                ...
                <div class="form-group" style="margin-left:10px;">
                    ...
                    <input type="date"
                           ...
                           id="tgl_akhir"
                           class="form-control"
                           value="<?php echo html_escape($tgl_akhir); ?>"
                           required>
                </div>
                ...
                <div class="form-group" style="margin-left:10px;">
                    ...
                    <input type="text"
                           ...
                           id="keyword"
                           class="form-control"
                           placeholder="Nama pasien / ID kunjungan"
                           value="<?php echo isset($keyword) ? html_escape($keyword) : ''; ?>">
                </div>
                ...
                <?php if (!empty($laporan)): ?>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Rp <?php echo number_format($item->total_akhir, 0, ',', '.'); ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <?php
                        // parameter untuk print & export
                        $query_params = '?tgl_awal=' . urlencode($tgl_awal)
                                      . '&tgl_akhir=' . urlencode($tgl_akhir)
                ...
                <?php elseif ($this->input->post()): ?>
                    ...
                    <div class="alert alert-warning">
                        Tidak ada data pembayaran pada rentang tanggal / pencarian tersebut.
                    </div>

                <?php else: ?>

                    <div class="alert alert-info">
                        Silahkan pilih rentang tanggal untuk menampilkan laporan.
                    </div>
